...
public class HookCreateInteractHookTargetEntityCommand extends Command
{
    public HookCreateInteractHookTargetEntityCommand() {
    ...
    public CommandResponse execute(Player player, Set<String> flags, Map<String, Object> parameters, List<Object> baseParameters) throws CommandExecutionException {
        ...
        Registry.getInstance().registerEvent(itemName, new InteractHookTargetEntity((EffectWithLivingEntity) baseParameters.get(0)));
