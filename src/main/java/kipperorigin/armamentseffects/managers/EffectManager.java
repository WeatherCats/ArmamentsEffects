...
import kipperorigin.armamentseffects.managers.sources.value.LinearValueSource;
import kipperorigin.armamentseffects.managers.sources.value.SinewaveValueSource;
